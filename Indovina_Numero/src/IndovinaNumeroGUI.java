...
public class IndovinaNumeroGUI extends JFrame {
    ...
    public IndovinaNumeroGUI() {
        ...
        godMode.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                tentativi = 1;
                provaButton .setText("Non provare a vincere Facile!!!");
                // Disabilita reset per renderla "inscappabile"
                resetButton.setEnabled(false);
                tentativiLabel.setText("Hai un Tentativo >:-)");
                ...
                provaButton.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ...
                        messaggioLabel.setText("GAME OVER.");
                    }
                });
            }
        });
    ...
    private void controllaTentativo() {
        try {
            ...
            if (tentativi < 1 && numeroInserito != numeroSegreto) {
